...
use mssf_com::FabricTypes::{
    FABRIC_CLIENT_ROLE, FABRIC_QUERY_REPLICATOR_OPERATION_NAME,
    FABRIC_QUERY_SERVICE_OPERATION_NAME, FABRIC_SERVICE_NOTIFICATION_FILTER_DESCRIPTION,
...
bitflags::bitflags! {
    ...
    pub struct ServiceNotificationFilterFlags: i32{
        const None = FABRIC_SERVICE_NOTIFICATION_FILTER_FLAGS::FABRIC_SERVICE_NOTIFICATION_FILTER_FLAGS_NONE.0;
        const NamePrefix = FABRIC_SERVICE_NOTIFICATION_FILTER_FLAGS::FABRIC_SERVICE_NOTIFICATION_FILTER_FLAGS_NAME_PREFIX.0;
        const PrimaryOnly = FABRIC_SERVICE_NOTIFICATION_FILTER_FLAGS::FABRIC_SERVICE_NOTIFICATION_FILTER_FLAGS_PRIMARY_ONLY.0;
    }
}
...
impl From<FABRIC_CLIENT_ROLE> for ClientRole {
    fn from(value: FABRIC_CLIENT_ROLE) -> Self {
        match value {
            FABRIC_CLIENT_ROLE::FABRIC_CLIENT_ROLE_UNKNOWN => Self::Unknown,
            FABRIC_CLIENT_ROLE::FABRIC_CLIENT_ROLE_USER => Self::User,
            FABRIC_CLIENT_ROLE::FABRIC_CLIENT_ROLE_ADMIN => Self::Admin,
            // FABRIC_CLIENT_ROLE::FABRIC_CLIENT_ROLE_ELEVATED_ADMIN => Self::ElevatedAdmin,
            _ => Self::Unknown,
        }
    }
}
...
impl From<ClientRole> for FABRIC_CLIENT_ROLE {
    fn from(value: ClientRole) -> Self {
        match value {
            ClientRole::Unknown => FABRIC_CLIENT_ROLE::FABRIC_CLIENT_ROLE_UNKNOWN,
            ClientRole::User => FABRIC_CLIENT_ROLE::FABRIC_CLIENT_ROLE_USER,
            ClientRole::Admin => FABRIC_CLIENT_ROLE::FABRIC_CLIENT_ROLE_ADMIN,
        }
    }
}
...
impl From<FABRIC_QUERY_SERVICE_OPERATION_NAME> for QueryServiceOperationName {
    fn from(value: FABRIC_QUERY_SERVICE_OPERATION_NAME) -> Self {
        match value {
            FABRIC_QUERY_SERVICE_OPERATION_NAME::FABRIC_QUERY_SERVICE_OPERATION_NAME_ABORT => {
                Self::Abort
            }
            FABRIC_QUERY_SERVICE_OPERATION_NAME::FABRIC_QUERY_SERVICE_OPERATION_NAME_CHANGEROLE => {
                Self::ChangeRole
            }
            FABRIC_QUERY_SERVICE_OPERATION_NAME::FABRIC_QUERY_SERVICE_OPERATION_NAME_CLOSE => {
                Self::Close
            }
            FABRIC_QUERY_SERVICE_OPERATION_NAME::FABRIC_QUERY_SERVICE_OPERATION_NAME_NONE => {
                Self::None
            }
            FABRIC_QUERY_SERVICE_OPERATION_NAME::FABRIC_QUERY_SERVICE_OPERATION_NAME_OPEN => {
                Self::Open
            }
            _ => Self::Invalid,
        }
...
impl From<FABRIC_QUERY_REPLICATOR_OPERATION_NAME> for QueryReplicatorOperationName {
    fn from(value: FABRIC_QUERY_REPLICATOR_OPERATION_NAME) -> Self {
        match value {
            FABRIC_QUERY_REPLICATOR_OPERATION_NAME::FABRIC_QUERY_REPLICATOR_OPERATION_NAME_ABORT => Self::Abort,
            FABRIC_QUERY_REPLICATOR_OPERATION_NAME::FABRIC_QUERY_REPLICATOR_OPERATION_NAME_BUILD => Self::Build,
            FABRIC_QUERY_REPLICATOR_OPERATION_NAME::FABRIC_QUERY_REPLICATOR_OPERATION_NAME_CHANGEROLE => Self::ChangeRole,
            FABRIC_QUERY_REPLICATOR_OPERATION_NAME::FABRIC_QUERY_REPLICATOR_OPERATION_NAME_CLOSE => Self::Close,
            FABRIC_QUERY_REPLICATOR_OPERATION_NAME::FABRIC_QUERY_REPLICATOR_OPERATION_NAME_NONE => Self::None,
            FABRIC_QUERY_REPLICATOR_OPERATION_NAME::FABRIC_QUERY_REPLICATOR_OPERATION_NAME_ONDATALOSS => Self::OnDataLoss,
            FABRIC_QUERY_REPLICATOR_OPERATION_NAME::FABRIC_QUERY_REPLICATOR_OPERATION_NAME_OPEN => Self::Open,
            FABRIC_QUERY_REPLICATOR_OPERATION_NAME::FABRIC_QUERY_REPLICATOR_OPERATION_NAME_UPDATEEPOCH => Self::UpdateEpoch,
            FABRIC_QUERY_REPLICATOR_OPERATION_NAME::FABRIC_QUERY_REPLICATOR_OPERATION_NAME_WAITFORCATCHUP => Self::WaitForCatchup,
            _ => Self::Invalid,
        }
    }
}
