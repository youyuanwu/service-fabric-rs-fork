...
pub struct DeleteServiceDescription {
    pub service_name: Uri,
    pub force_delete: bool,
}

impl DeleteServiceDescription {
    pub fn new(service_name: Uri) -> Self {
        Self {
            service_name,
            force_delete: false,
        }
    ...
    pub fn with_force_delete(mut self, force_delete: bool) -> Self {
        self.force_delete = force_delete;
        self
    }
}

impl GetRaw<FABRIC_DELETE_SERVICE_DESCRIPTION> for DeleteServiceDescription {
    fn get_raw(&self) -> FABRIC_DELETE_SERVICE_DESCRIPTION {
