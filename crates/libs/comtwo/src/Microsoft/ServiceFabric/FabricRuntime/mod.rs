...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P4: windows_core::Param<super::FabricTypes::FABRIC_URI>,
...
{
    windows_targets::link!("fabricruntime" "system" fn FabricCreateKeyValueStoreReplica5(riid : *const windows_core::GUID, storename : windows_core::PCWSTR, partitionid : windows_core::GUID, replicaid : i64, servicename : super::FabricTypes:: FABRIC_URI, replicatorsettings : *const super::FabricTypes:: FABRIC_REPLICATOR_SETTINGS, kvssettings : *const super::FabricTypes:: FABRIC_KEY_VALUE_STORE_REPLICA_SETTINGS, localstorekind : super::FabricTypes:: FABRIC_LOCAL_STORE_KIND, localstoresettings : *const core::ffi::c_void, storeeventhandler : * mut core::ffi::c_void, secondaryeventhandler : * mut core::ffi::c_void, keyvaluestore : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    let mut result__ = core::mem::zeroed();
